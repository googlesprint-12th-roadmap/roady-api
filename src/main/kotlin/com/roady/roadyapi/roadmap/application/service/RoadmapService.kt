...
class RoadmapService(
    ...
    override fun editRoadmap(edit: EditRoadmap): Long {
        ...
        val roadmap = roadmapPersistenceOutput.findByIdx(edit.idx)
    ...
    override fun deleteRoadmap(delete: DeleteRoadmap) {
        ...
        roadmapPersistenceOutput.deleteByIdx(delete.idx)
    }
    ...
    private fun validate(delete: DeleteRoadmap) {
        ...
        val roadmap = roadmapPersistenceOutput.findByIdx(delete.idx)
